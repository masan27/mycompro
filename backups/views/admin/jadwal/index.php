        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="font-weight-bold text-primary" style="display: inline-block; margin-right: 1em;">Daftar Jadwal</h6>
              <div class="form-row" style="display: inline-flex; min-width: 50%;">
                <div class="col-6">
                  <a href="<?php echo base_url('admin/jadwal/add') ?>" class="btn btn-primary btn-icon-split btn-sm">
                    ...
                    <tbody>
                      ...
                      foreach ($items as $item) : ?>
                        <tr>
                          ...
                          <td>
                            <?php echo '<span style="display:none;">' . $item->hari_id . '</span>' . $item->hari ?>
                          </td>
                          <td>
                            <?php echo $item->mulai . ' - ' . $item->selesai ?>
                          </td>
                          <td>
                            <?php echo $item->nama_astur ?>
                          </td>
                          <td align="center">
                            <a href="<?php echo base_url('admin/jadwal/edit/') . $item->id ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                            <a onclick="deleteConfirm('<?php echo base_url('admin/jadwal/delete/' . $item->id) ?>')" href="#!" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
