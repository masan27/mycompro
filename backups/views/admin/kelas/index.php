        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="font-weight-bold text-primary" style="display: inline-block; margin-right: 1em;">Daftar Kelas</h6>
              <div class="form-row" style="display: inline-flex; min-width: 50%;">
              <div class="col-6">
                  <a href="<?php echo base_url('admin/kelas/add') ?>" class="btn btn-primary btn-icon-split btn-sm">
                    ...
                    <tbody>
                      ...
                      foreach ($items as $item) : ?>
                        <tr>
                          ...
                          <td align="center">
                            <a href="<?php echo base_url('admin/kelas/edit/') . $item->id ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                            <a onclick="deleteConfirm('<?php echo base_url('admin/kelas/delete/' . $item->id) ?>')" href="#!" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                      <?php endforeach; ?>
                    </tbody>
