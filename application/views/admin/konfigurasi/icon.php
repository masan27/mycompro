    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="<?= $bg_d ?>" id="content">
        ...
        <div class="<?= $bg_d ?> container-fluid">
          ...
          <!-- Form -->
          <?php
          echo form_open_multipart(base_url('admin/pengaturan/web/icon'));
          ?>
            ...
            <div class="card-body">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-12">
                  <div class="custom-file">
                    ...
                    <input id="icon" type="file" name="icon" onchange="previewImage();" multiple="multiple" accept="image/*" class="custom-file-input" placeholder="Upload Icon">
              ...
              <div class="form-row">              
                <div class="form-group col-md-6 text-center">
                  <label>Icon Baru</label><br>
                  <img id="image-preview" style="max-width: 300px; max-height: auto;">
                </div>            

                <div class="form-group col-md-6 text-center"> 
                  <label>Icon Lama</label><br>
                  <?php if ($site->icon == 'awal.ico') : ?>
                    <img src="<?php echo base_url('assets/pendukung/' . $site->icon) ?>" style="max-width:300px; height:auto;">
                  <?php else : ?>
                    <img src="<?php echo base_url('upload/image/' . $site->icon) ?>" style="max-width:300px; height:auto;">
                  <?php endif; ?>
                </div>
