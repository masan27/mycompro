            ...
            <div class="card-body">
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" name="username" id="username" value="<?php echo set_value('username', $items->username) ?>" class="form-control <?= $num ?> <?php echo form_error('username') ? 'is-invalid' : '' ?>">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <select name="aktif" id="aktif" class="form-control">
                    <option value="Y" <?php echo set_select('aktif', 'Y', ($items->aktif == 'Y')) ?>>Aktif</option>
                    <option value="N" <?php echo set_select('aktif', 'N', ($items->aktif == 'N')) ?>>Tidak Aktif</option>
                  </select>
                </div>
              </div>
            </div>
