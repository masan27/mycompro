    ...
    <div class="modal-dialog modal-lg <?= $bg . ' ' . $txt ?>">
      <div class="modal-content <?= $bg . ' ' . $txt ?>">
        ...
        <div class="modal-body <?= $bg . ' ' . $txt ?>">
          ...
          // Form buka 
          echo form_open_multipart(base_url('admin/download/' . $edit->id_download));
          ?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="form-group form-group-lg">
                ...
                <input type="text" name="judul_download" class="form-control" placeholder="Judul download" value="<?php echo set_value('judul_download', $edit->judul_download) ?>">
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="custom-file">
                ...
                <input id="tambah_gambar" type="file" name="gambar" accept=".pdf,.zip,.rar,.doc,.docx,.xls,.xlsx,.ppt,pptx" class="custom-file-input file-tambah" placeholder="Upload gambar">
