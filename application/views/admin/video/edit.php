          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="judul" class="form-control" value="<?php echo set_value('judul', $edit->judul) ?>" required placeholder="Judul Video">
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select name="posisi" class="form-control">
                  <option value="Homepage" <?php if ($edit->posisi == "Homepage") {
                                              echo "selected";
                                            } ?>>Homepage - Main page</option>
                  <option value="Video" <?php if ($edit->posisi == "Video") {
                                          echo "selected";
                                        } ?>>Video - Video page</option>
                </select>
              </div>
            </div>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <textarea name="keterangan" placeholder="Keterangan" class="form-control" id="keterangan"><?php echo set_value('keterangan', $edit->keterangan) ?></textarea>
              </div>
            </div>
